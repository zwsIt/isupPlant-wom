package com.supcon.mes.module_wom_ble.util;
...
public class VerticalSpaceDecoration extends RecyclerView.ItemDecoration {
    ...
    public VerticalSpaceDecoration(){
        mPaint=new Paint();
     ...
     * @return
     */
    public VerticalSpaceDecoration setMargin(float margin){
        this.margin=margin;
        return this;
    }
     ...
     * @return
     */
    public VerticalSpaceDecoration setColor(int color){
     ...
     * @return
     */
    public VerticalSpaceDecoration setDeiverHeight(float height){
