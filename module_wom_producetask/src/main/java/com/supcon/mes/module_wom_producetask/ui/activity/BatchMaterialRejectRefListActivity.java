 ...
 * Desc 退料配料记录参照list
 */
@Router(Constant.Router.BATCH_MATERIAL_REJECT_LIST_REF)
@Presenter(value = {BatchMaterialRecordsRefPresenter.class})
public class BatchMaterialRejectRefListActivity extends BaseRefreshRecyclerActivity<BatchMaterialPartEntity> implements CommonListContract.View {
    ...
    protected void initListener() {
        ...
        refreshListController.setOnRefreshPageListener(pageIndex -> {
            ...
            presenterRouter.create(CommonListAPI.class).list(pageIndex, customCondition, queryParams, WomConstant.URL.BATCH_MATERIAL_RELECT_LIST_REF_URL, "batMaterilPart");
        });
