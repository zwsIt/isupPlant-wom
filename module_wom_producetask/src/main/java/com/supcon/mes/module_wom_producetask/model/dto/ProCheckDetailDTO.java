...
public class ProCheckDetailDTO extends BaseEntity {
     ...
     * uploadFileFormMap : []
     * ids2del :
     * viewCode : WOM_1.0.0_procReport_checkFeedBackEdit
     */
    ...
    public static class DgListEntity {
        ...
        @SerializedName(value = WomConstant.DG_NAME.DG_CHECK_ACTIVITY_REPORT)
        private String dg;
