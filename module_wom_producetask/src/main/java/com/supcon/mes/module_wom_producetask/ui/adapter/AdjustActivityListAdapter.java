...
public class AdjustActivityListAdapter extends BaseListDataRecyclerViewAdapter<TaskActiveEntity> {
    public AdjustActivityListAdapter(Context context) {
        super(context);
    }
    ...
    @Override
    public int getItemViewType(int position, TaskActiveEntity taskActiveEntity) {
