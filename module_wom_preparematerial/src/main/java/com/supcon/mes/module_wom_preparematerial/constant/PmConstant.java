package com.supcon.mes.module_wom_preparematerial.constant;
...
//        String BM_INSTRUCTION_EDIT = "TaskEvent_09367jb"; // 配料指令单编辑
     ...
     */
    interface URL {
        String PREPARE_MATERIAL_RELECT_LIST_REF_URL = "/msService/WOM/prepareMaterial/prepMatralPart/prepRecordForReject-query"; // 退料备料记录参照list
