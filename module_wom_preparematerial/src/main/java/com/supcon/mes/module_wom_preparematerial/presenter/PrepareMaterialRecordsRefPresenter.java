 ...
 * Desc
 */
public class PrepareMaterialRecordsRefPresenter extends CommonListContract.Presenter {
    @Override
    public void list(int pageNo, Map<String, Object> customCondition, Map<String, Object> queryParams, String url, String modelAlias) {
        ...
        JoinSubcondEntity joinSubcondEntity = BAPQueryParamsHelper.crateJoinSubcondEntity(queryParams,"BASESET_MATERIALS,ID,WOM_PREP_MATRAL_PARTS,MATERIAL_ID");
