...
public class ReplenishMaterialTableEditFragment extends BaseRefreshRecyclerFragment<ReplenishMaterialTableEntity> implements ReplenishMaterialTableListContract.View {
    ...
    protected void initListener() {
        ...
        refreshListController.setOnRefreshPageListener(pageIndex -> {
            ...
            presenterRouter.create(ReplenishMaterialTableListAPI.class).listReplenishMaterialTables(pageIndex, ReplenishConstant.URL.REPLENISH_MATERIAL_PENDING_LIST_URL,queryParams);
        });
    }
